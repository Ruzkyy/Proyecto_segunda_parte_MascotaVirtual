...
public class DormirPinguino extends JFrame {
    ...
    public static void main(String[] args) {
    	EventQueue.invokeLater(() -> {
            try {
    	DormirPinguino frame = new DormirPinguino();
    ...
    public DormirPinguino() {   
        ...
        getContentPane().add(btnregresar);
                ...
                jLabel2 = new JLabel("");
                jLabel2.setIcon(new ImageIcon(DormirPinguino.class.getResource("/Fondos/fondo pinguino dormir.jpg")));
