...
public class Dormir extends JFrame {
    ...
    public Dormir() {
        ...
        btnregresar.setBounds(0, 425, 200, 90);
        ...
        jLabel2 = new JLabel("");
        jLabel2.setIcon(new ImageIcon(Dormir.class.getResource("/Fondos/Noche.png")));
        jLabel2.setBounds(0, 11, 1169, 521);
