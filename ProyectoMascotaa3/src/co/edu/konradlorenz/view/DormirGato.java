...
public class DormirGato extends JFrame {
    ...
    private JLabel jLabel1, jLabel2, jLabel3, jLabel4, jLabel5, jLabel6, jLabel7, jLabel8, jLabel9, jLabel10, jLabel11, jLabelNom;
    private JButton BtnDiez, BtnVeinte, BtnTreinta, BtnCuarenta, BtnCincuenta, BtnSesenta, BtnSetenta, BtnOchenta, BtnNoventa, BtnCien, btnregresar;
    private JButton btnCientoUno;

    public static void main(String[] args) {
    	EventQueue.invokeLater(() -> {
            try {
                DormirGato frame = new DormirGato();                
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
    ...
    public DormirGato() {
        ...
        jLabel2 = new JLabel("");
        jLabel2.setIcon(new ImageIcon(DormirGato.class.getResource("/Fondos/fondo gato dormir.jpg")));
